...
<head>
    ...
    <title>SEARCH CHARTER TRIP - RC Charter Company</title>
...
<body>
    ...
    <ul id="navigation">
        ...
        <li class="selected"><a href="search_c.php">SEARCH_CHARTER</a></li>
    </ul>
    <div id="footer" style="margin-left:-9px; width:1519px; height:1050px; background-color:#FFF4C1;">
        <br/><br/>
        <form action="searchcheck_c.php" method="POST">
            <h1>
                <center>
                    <font size="3" face="monospace">
                        <b>Charter ID Search: <input type="text" name="Charter_trip_ID"></b>
                    </font>
                </center>
            </h1>
            <center>
